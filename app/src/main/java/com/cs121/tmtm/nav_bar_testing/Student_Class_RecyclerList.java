...
public class Student_Class_RecyclerList extends RecyclerView.Adapter<Student_Class_RecyclerList.MyViewHolder> {

    private List<String> classList;
    private Context context;

    public Student_Class_RecyclerList(List<String> classList) {
    ...
    @NonNull
    @Override
    public Student_Class_RecyclerList.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Student_Class_RecyclerList.MyViewHolder myViewHolder, int i) {
        ...
        myViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Student_project_page_fragment project_fragment = new Student_project_page_fragment();
