 ...
 * {@link Student_user_profile_fragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Student_user_profile_fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Student_user_profile_fragment extends Fragment {
    ...
    public Student_user_profile_fragment() {
    ...
    public static Student_user_profile_fragment newInstance(String param1, String param2) {
        Student_user_profile_fragment fragment = new Student_user_profile_fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_student_user_profile, container, false);
        ...
        projectView = (RecyclerView) rootView.findViewById(R.id.profile_projectView);
        classView.setLayoutManager(new LinearLayoutManager(getActivity()));
        projectView.setLayoutManager(new LinearLayoutManager(getActivity()));
        studentName = (TextView) rootView.findViewById(R.id.studentName);
        studentID = (TextView) rootView.findViewById(R.id.studentID);
        studentName.setText(this_user.getEmail());
        studentID.setText(this_user.getUid());
        ...
        studentReference.child(this_user.getUid()).child("myClass").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot myClasses : dataSnapshot.getChildren()){
                    ...
                    Log.i("Student class", "Add class: " + classTitleID);
                }
        ...
        studentReference.child(this_user.getUid()).child("myProject").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
